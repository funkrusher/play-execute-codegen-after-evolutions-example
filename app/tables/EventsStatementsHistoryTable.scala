package tables
// AUTO-GENERATED Slick data model for table EventsStatementsHistory
trait EventsStatementsHistoryTable {
  ...
  /** Entity class storing rows of table EventsStatementsHistory
  ...
  /** Collection-like TableQuery object for table EventsStatementsHistory */
  lazy val EventsStatementsHistory = new TableQuery(tag => new EventsStatementsHistory(tag))
}
