package tables
// AUTO-GENERATED Slick data model for table TableIoWaitsSummaryByIndexUsage
trait TableIoWaitsSummaryByIndexUsageTable {
  ...
  /** Entity class storing rows of table TableIoWaitsSummaryByIndexUsage
  ...
  /** Collection-like TableQuery object for table TableIoWaitsSummaryByIndexUsage */
  lazy val TableIoWaitsSummaryByIndexUsage = new TableQuery(tag => new TableIoWaitsSummaryByIndexUsage(tag))
}
