...
trait PlayEvolutionsTable {
  ...
  case class PlayEvolutionsRow(id: Int, hash: String, applied_at: java.sql.Timestamp, apply_script: Option[String] = Some("NULL"), revert_script: Option[String] = Some("NULL"), state: Option[String] = Some("NULL"), last_problem: Option[String] = Some("NULL"))
