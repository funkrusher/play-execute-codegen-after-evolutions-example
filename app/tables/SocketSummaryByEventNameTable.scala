package tables
// AUTO-GENERATED Slick data model for table SocketSummaryByEventName
trait SocketSummaryByEventNameTable {
  ...
  /** Entity class storing rows of table SocketSummaryByEventName
  ...
  case class SocketSummaryByEventNameRow(EVENT_NAME: String, COUNT_STAR: Long, SUM_TIMER_WAIT: Long, MIN_TIMER_WAIT: Long, AVG_TIMER_WAIT: Long, MAX_TIMER_WAIT: Long, COUNT_READ: Long, SUM_TIMER_READ: Long, MIN_TIMER_READ: Long, AVG_TIMER_READ: Long, MAX_TIMER_READ: Long, SUM_NUMBER_OF_BYTES_READ: Long, COUNT_WRITE: Long, SUM_TIMER_WRITE: Long, MIN_TIMER_WRITE: Long, AVG_TIMER_WRITE: Long, MAX_TIMER_WRITE: Long, SUM_NUMBER_OF_BYTES_WRITE: Long, COUNT_MISC: Long, SUM_TIMER_MISC: Long, MIN_TIMER_MISC: Long, AVG_TIMER_MISC: Long, MAX_TIMER_MISC: Long)
  /** GetResult implicit for fetching SocketSummaryByEventNameRow objects using plain SQL queries */
  implicit def GetResultSocketSummaryByEventNameRow(implicit e0: GR[String], e1: GR[Long]): GR[SocketSummaryByEventNameRow] = GR{
    prs => import prs._
    SocketSummaryByEventNameRow(<<[String], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long])
  }
  /** Table description of table socket_summary_by_event_name. Objects of this class serve as prototypes for rows in queries. */
  class SocketSummaryByEventName(_tableTag: Tag) extends profile.api.Table[SocketSummaryByEventNameRow](_tableTag, Some("performance_schema"), "socket_summary_by_event_name") {
    def * = (EVENT_NAME :: COUNT_STAR :: SUM_TIMER_WAIT :: MIN_TIMER_WAIT :: AVG_TIMER_WAIT :: MAX_TIMER_WAIT :: COUNT_READ :: SUM_TIMER_READ :: MIN_TIMER_READ :: AVG_TIMER_READ :: MAX_TIMER_READ :: SUM_NUMBER_OF_BYTES_READ :: COUNT_WRITE :: SUM_TIMER_WRITE :: MIN_TIMER_WRITE :: AVG_TIMER_WRITE :: MAX_TIMER_WRITE :: SUM_NUMBER_OF_BYTES_WRITE :: COUNT_MISC :: SUM_TIMER_MISC :: MIN_TIMER_MISC :: AVG_TIMER_MISC :: MAX_TIMER_MISC :: HNil).mapTo[SocketSummaryByEventNameRow]
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(EVENT_NAME) :: Rep.Some(COUNT_STAR) :: Rep.Some(SUM_TIMER_WAIT) :: Rep.Some(MIN_TIMER_WAIT) :: Rep.Some(AVG_TIMER_WAIT) :: Rep.Some(MAX_TIMER_WAIT) :: Rep.Some(COUNT_READ) :: Rep.Some(SUM_TIMER_READ) :: Rep.Some(MIN_TIMER_READ) :: Rep.Some(AVG_TIMER_READ) :: Rep.Some(MAX_TIMER_READ) :: Rep.Some(SUM_NUMBER_OF_BYTES_READ) :: Rep.Some(COUNT_WRITE) :: Rep.Some(SUM_TIMER_WRITE) :: Rep.Some(MIN_TIMER_WRITE) :: Rep.Some(AVG_TIMER_WRITE) :: Rep.Some(MAX_TIMER_WRITE) :: Rep.Some(SUM_NUMBER_OF_BYTES_WRITE) :: Rep.Some(COUNT_MISC) :: Rep.Some(SUM_TIMER_MISC) :: Rep.Some(MIN_TIMER_MISC) :: Rep.Some(AVG_TIMER_MISC) :: Rep.Some(MAX_TIMER_MISC) :: HNil).shaped.<>(r => SocketSummaryByEventNameRow(r(0).asInstanceOf[Option[String]].get, r(1).asInstanceOf[Option[Long]].get, r(2).asInstanceOf[Option[Long]].get, r(3).asInstanceOf[Option[Long]].get, r(4).asInstanceOf[Option[Long]].get, r(5).asInstanceOf[Option[Long]].get, r(6).asInstanceOf[Option[Long]].get, r(7).asInstanceOf[Option[Long]].get, r(8).asInstanceOf[Option[Long]].get, r(9).asInstanceOf[Option[Long]].get, r(10).asInstanceOf[Option[Long]].get, r(11).asInstanceOf[Option[Long]].get, r(12).asInstanceOf[Option[Long]].get, r(13).asInstanceOf[Option[Long]].get, r(14).asInstanceOf[Option[Long]].get, r(15).asInstanceOf[Option[Long]].get, r(16).asInstanceOf[Option[Long]].get, r(17).asInstanceOf[Option[Long]].get, r(18).asInstanceOf[Option[Long]].get, r(19).asInstanceOf[Option[Long]].get, r(20).asInstanceOf[Option[Long]].get, r(21).asInstanceOf[Option[Long]].get, r(22).asInstanceOf[Option[Long]].get), (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Collection-like TableQuery object for table SocketSummaryByEventName */
  lazy val SocketSummaryByEventName = new TableQuery(tag => new SocketSummaryByEventName(tag))
}
