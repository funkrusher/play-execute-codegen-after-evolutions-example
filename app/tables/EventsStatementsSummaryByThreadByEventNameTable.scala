package tables
// AUTO-GENERATED Slick data model for table EventsStatementsSummaryByThreadByEventName
trait EventsStatementsSummaryByThreadByEventNameTable {
  ...
  /** Entity class storing rows of table EventsStatementsSummaryByThreadByEventName
  ...
  case class EventsStatementsSummaryByThreadByEventNameRow(THREAD_ID: Long, EVENT_NAME: String, COUNT_STAR: Long, SUM_TIMER_WAIT: Long, MIN_TIMER_WAIT: Long, AVG_TIMER_WAIT: Long, MAX_TIMER_WAIT: Long, SUM_LOCK_TIME: Long, SUM_ERRORS: Long, SUM_WARNINGS: Long, SUM_ROWS_AFFECTED: Long, SUM_ROWS_SENT: Long, SUM_ROWS_EXAMINED: Long, SUM_CREATED_TMP_DISK_TABLES: Long, SUM_CREATED_TMP_TABLES: Long, SUM_SELECT_FULL_JOIN: Long, SUM_SELECT_FULL_RANGE_JOIN: Long, SUM_SELECT_RANGE: Long, SUM_SELECT_RANGE_CHECK: Long, SUM_SELECT_SCAN: Long, SUM_SORT_MERGE_PASSES: Long, SUM_SORT_RANGE: Long, SUM_SORT_ROWS: Long, SUM_SORT_SCAN: Long, SUM_NO_INDEX_USED: Long, SUM_NO_GOOD_INDEX_USED: Long)
  /** GetResult implicit for fetching EventsStatementsSummaryByThreadByEventNameRow objects using plain SQL queries */
  implicit def GetResultEventsStatementsSummaryByThreadByEventNameRow(implicit e0: GR[Long], e1: GR[String]): GR[EventsStatementsSummaryByThreadByEventNameRow] = GR{
    prs => import prs._
    EventsStatementsSummaryByThreadByEventNameRow(<<[Long], <<[String], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long])
  }
  /** Table description of table events_statements_summary_by_thread_by_event_name. Objects of this class serve as prototypes for rows in queries. */
  class EventsStatementsSummaryByThreadByEventName(_tableTag: Tag) extends profile.api.Table[EventsStatementsSummaryByThreadByEventNameRow](_tableTag, Some("performance_schema"), "events_statements_summary_by_thread_by_event_name") {
    def * = (THREAD_ID :: EVENT_NAME :: COUNT_STAR :: SUM_TIMER_WAIT :: MIN_TIMER_WAIT :: AVG_TIMER_WAIT :: MAX_TIMER_WAIT :: SUM_LOCK_TIME :: SUM_ERRORS :: SUM_WARNINGS :: SUM_ROWS_AFFECTED :: SUM_ROWS_SENT :: SUM_ROWS_EXAMINED :: SUM_CREATED_TMP_DISK_TABLES :: SUM_CREATED_TMP_TABLES :: SUM_SELECT_FULL_JOIN :: SUM_SELECT_FULL_RANGE_JOIN :: SUM_SELECT_RANGE :: SUM_SELECT_RANGE_CHECK :: SUM_SELECT_SCAN :: SUM_SORT_MERGE_PASSES :: SUM_SORT_RANGE :: SUM_SORT_ROWS :: SUM_SORT_SCAN :: SUM_NO_INDEX_USED :: SUM_NO_GOOD_INDEX_USED :: HNil).mapTo[EventsStatementsSummaryByThreadByEventNameRow]
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(THREAD_ID) :: Rep.Some(EVENT_NAME) :: Rep.Some(COUNT_STAR) :: Rep.Some(SUM_TIMER_WAIT) :: Rep.Some(MIN_TIMER_WAIT) :: Rep.Some(AVG_TIMER_WAIT) :: Rep.Some(MAX_TIMER_WAIT) :: Rep.Some(SUM_LOCK_TIME) :: Rep.Some(SUM_ERRORS) :: Rep.Some(SUM_WARNINGS) :: Rep.Some(SUM_ROWS_AFFECTED) :: Rep.Some(SUM_ROWS_SENT) :: Rep.Some(SUM_ROWS_EXAMINED) :: Rep.Some(SUM_CREATED_TMP_DISK_TABLES) :: Rep.Some(SUM_CREATED_TMP_TABLES) :: Rep.Some(SUM_SELECT_FULL_JOIN) :: Rep.Some(SUM_SELECT_FULL_RANGE_JOIN) :: Rep.Some(SUM_SELECT_RANGE) :: Rep.Some(SUM_SELECT_RANGE_CHECK) :: Rep.Some(SUM_SELECT_SCAN) :: Rep.Some(SUM_SORT_MERGE_PASSES) :: Rep.Some(SUM_SORT_RANGE) :: Rep.Some(SUM_SORT_ROWS) :: Rep.Some(SUM_SORT_SCAN) :: Rep.Some(SUM_NO_INDEX_USED) :: Rep.Some(SUM_NO_GOOD_INDEX_USED) :: HNil).shaped.<>(r => EventsStatementsSummaryByThreadByEventNameRow(r(0).asInstanceOf[Option[Long]].get, r(1).asInstanceOf[Option[String]].get, r(2).asInstanceOf[Option[Long]].get, r(3).asInstanceOf[Option[Long]].get, r(4).asInstanceOf[Option[Long]].get, r(5).asInstanceOf[Option[Long]].get, r(6).asInstanceOf[Option[Long]].get, r(7).asInstanceOf[Option[Long]].get, r(8).asInstanceOf[Option[Long]].get, r(9).asInstanceOf[Option[Long]].get, r(10).asInstanceOf[Option[Long]].get, r(11).asInstanceOf[Option[Long]].get, r(12).asInstanceOf[Option[Long]].get, r(13).asInstanceOf[Option[Long]].get, r(14).asInstanceOf[Option[Long]].get, r(15).asInstanceOf[Option[Long]].get, r(16).asInstanceOf[Option[Long]].get, r(17).asInstanceOf[Option[Long]].get, r(18).asInstanceOf[Option[Long]].get, r(19).asInstanceOf[Option[Long]].get, r(20).asInstanceOf[Option[Long]].get, r(21).asInstanceOf[Option[Long]].get, r(22).asInstanceOf[Option[Long]].get, r(23).asInstanceOf[Option[Long]].get, r(24).asInstanceOf[Option[Long]].get, r(25).asInstanceOf[Option[Long]].get), (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Collection-like TableQuery object for table EventsStatementsSummaryByThreadByEventName */
  lazy val EventsStatementsSummaryByThreadByEventName = new TableQuery(tag => new EventsStatementsSummaryByThreadByEventName(tag))
}
