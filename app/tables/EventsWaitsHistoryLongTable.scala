package tables
// AUTO-GENERATED Slick data model for table EventsWaitsHistoryLong
trait EventsWaitsHistoryLongTable {
  ...
  /** Entity class storing rows of table EventsWaitsHistoryLong
  ...
  case class EventsWaitsHistoryLongRow(THREAD_ID: Long, EVENT_ID: Long, END_EVENT_ID: Option[Long], EVENT_NAME: String, SOURCE: Option[String], TIMER_START: Option[Long], TIMER_END: Option[Long], TIMER_WAIT: Option[Long], SPINS: Option[Long], OBJECT_SCHEMA: Option[String], OBJECT_NAME: Option[String], INDEX_NAME: Option[String], OBJECT_TYPE: Option[String], OBJECT_INSTANCE_BEGIN: Long, NESTING_EVENT_ID: Option[Long], NESTING_EVENT_TYPE: Option[String], OPERATION: String, NUMBER_OF_BYTES: Option[Long], FLAGS: Option[Long])
  /** GetResult implicit for fetching EventsWaitsHistoryLongRow objects using plain SQL queries */
  implicit def GetResultEventsWaitsHistoryLongRow(implicit e0: GR[Long], e1: GR[Option[Long]], e2: GR[String], e3: GR[Option[String]]): GR[EventsWaitsHistoryLongRow] = GR{
    prs => import prs._
    EventsWaitsHistoryLongRow.tupled((<<[Long], <<[Long], <<?[Long], <<[String], <<?[String], <<?[Long], <<?[Long], <<?[Long], <<?[Long], <<?[String], <<?[String], <<?[String], <<?[String], <<[Long], <<?[Long], <<?[String], <<[String], <<?[Long], <<?[Long]))
  }
  /** Table description of table events_waits_history_long. Objects of this class serve as prototypes for rows in queries. */
  class EventsWaitsHistoryLong(_tableTag: Tag) extends profile.api.Table[EventsWaitsHistoryLongRow](_tableTag, Some("performance_schema"), "events_waits_history_long") {
    def * = (THREAD_ID, EVENT_ID, END_EVENT_ID, EVENT_NAME, SOURCE, TIMER_START, TIMER_END, TIMER_WAIT, SPINS, OBJECT_SCHEMA, OBJECT_NAME, INDEX_NAME, OBJECT_TYPE, OBJECT_INSTANCE_BEGIN, NESTING_EVENT_ID, NESTING_EVENT_TYPE, OPERATION, NUMBER_OF_BYTES, FLAGS).<>(EventsWaitsHistoryLongRow.tupled, EventsWaitsHistoryLongRow.unapply)
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = ((Rep.Some(THREAD_ID), Rep.Some(EVENT_ID), END_EVENT_ID, Rep.Some(EVENT_NAME), SOURCE, TIMER_START, TIMER_END, TIMER_WAIT, SPINS, OBJECT_SCHEMA, OBJECT_NAME, INDEX_NAME, OBJECT_TYPE, Rep.Some(OBJECT_INSTANCE_BEGIN), NESTING_EVENT_ID, NESTING_EVENT_TYPE, Rep.Some(OPERATION), NUMBER_OF_BYTES, FLAGS)).shaped.<>({r=>import r._; _1.map(_=> EventsWaitsHistoryLongRow.tupled((_1.get, _2.get, _3, _4.get, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14.get, _15, _16, _17.get, _18, _19)))}, (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
  ...
  /** Collection-like TableQuery object for table EventsWaitsHistoryLong */
  lazy val EventsWaitsHistoryLong = new TableQuery(tag => new EventsWaitsHistoryLong(tag))
}
