package tables
// AUTO-GENERATED Slick data model for table EventsStatementsCurrent
trait EventsStatementsCurrentTable {
  ...
  /** Entity class storing rows of table EventsStatementsCurrent
  ...
  /** Collection-like TableQuery object for table EventsStatementsCurrent */
  lazy val EventsStatementsCurrent = new TableQuery(tag => new EventsStatementsCurrent(tag))
}
