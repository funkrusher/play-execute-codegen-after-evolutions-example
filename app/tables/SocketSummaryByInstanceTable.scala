package tables
// AUTO-GENERATED Slick data model for table SocketSummaryByInstance
trait SocketSummaryByInstanceTable {
  ...
  /** Entity class storing rows of table SocketSummaryByInstance
   ...
   *  @param SUM_NUMBER_OF_BYTES_READ Database column SUM_NUMBER_OF_BYTES_READ SqlType(BIGINT UNSIGNED)
   ...
   *  @param SUM_NUMBER_OF_BYTES_WRITE Database column SUM_NUMBER_OF_BYTES_WRITE SqlType(BIGINT UNSIGNED)
  ...
  case class SocketSummaryByInstanceRow(EVENT_NAME: String, OBJECT_INSTANCE_BEGIN: Long, COUNT_STAR: Long, SUM_TIMER_WAIT: Long, MIN_TIMER_WAIT: Long, AVG_TIMER_WAIT: Long, MAX_TIMER_WAIT: Long, COUNT_READ: Long, SUM_TIMER_READ: Long, MIN_TIMER_READ: Long, AVG_TIMER_READ: Long, MAX_TIMER_READ: Long, SUM_NUMBER_OF_BYTES_READ: Long, COUNT_WRITE: Long, SUM_TIMER_WRITE: Long, MIN_TIMER_WRITE: Long, AVG_TIMER_WRITE: Long, MAX_TIMER_WRITE: Long, SUM_NUMBER_OF_BYTES_WRITE: Long, COUNT_MISC: Long, SUM_TIMER_MISC: Long, MIN_TIMER_MISC: Long, AVG_TIMER_MISC: Long, MAX_TIMER_MISC: Long)
  /** GetResult implicit for fetching SocketSummaryByInstanceRow objects using plain SQL queries */
  implicit def GetResultSocketSummaryByInstanceRow(implicit e0: GR[String], e1: GR[Long]): GR[SocketSummaryByInstanceRow] = GR{
    prs => import prs._
    SocketSummaryByInstanceRow(<<[String], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long], <<[Long])
  }
  /** Table description of table socket_summary_by_instance. Objects of this class serve as prototypes for rows in queries. */
  class SocketSummaryByInstance(_tableTag: Tag) extends profile.api.Table[SocketSummaryByInstanceRow](_tableTag, Some("performance_schema"), "socket_summary_by_instance") {
    def * = (EVENT_NAME :: OBJECT_INSTANCE_BEGIN :: COUNT_STAR :: SUM_TIMER_WAIT :: MIN_TIMER_WAIT :: AVG_TIMER_WAIT :: MAX_TIMER_WAIT :: COUNT_READ :: SUM_TIMER_READ :: MIN_TIMER_READ :: AVG_TIMER_READ :: MAX_TIMER_READ :: SUM_NUMBER_OF_BYTES_READ :: COUNT_WRITE :: SUM_TIMER_WRITE :: MIN_TIMER_WRITE :: AVG_TIMER_WRITE :: MAX_TIMER_WRITE :: SUM_NUMBER_OF_BYTES_WRITE :: COUNT_MISC :: SUM_TIMER_MISC :: MIN_TIMER_MISC :: AVG_TIMER_MISC :: MAX_TIMER_MISC :: HNil).mapTo[SocketSummaryByInstanceRow]
    /** Maps whole row to an option. Useful for outer joins. */
    def ? = (Rep.Some(EVENT_NAME) :: Rep.Some(OBJECT_INSTANCE_BEGIN) :: Rep.Some(COUNT_STAR) :: Rep.Some(SUM_TIMER_WAIT) :: Rep.Some(MIN_TIMER_WAIT) :: Rep.Some(AVG_TIMER_WAIT) :: Rep.Some(MAX_TIMER_WAIT) :: Rep.Some(COUNT_READ) :: Rep.Some(SUM_TIMER_READ) :: Rep.Some(MIN_TIMER_READ) :: Rep.Some(AVG_TIMER_READ) :: Rep.Some(MAX_TIMER_READ) :: Rep.Some(SUM_NUMBER_OF_BYTES_READ) :: Rep.Some(COUNT_WRITE) :: Rep.Some(SUM_TIMER_WRITE) :: Rep.Some(MIN_TIMER_WRITE) :: Rep.Some(AVG_TIMER_WRITE) :: Rep.Some(MAX_TIMER_WRITE) :: Rep.Some(SUM_NUMBER_OF_BYTES_WRITE) :: Rep.Some(COUNT_MISC) :: Rep.Some(SUM_TIMER_MISC) :: Rep.Some(MIN_TIMER_MISC) :: Rep.Some(AVG_TIMER_MISC) :: Rep.Some(MAX_TIMER_MISC) :: HNil).shaped.<>(r => SocketSummaryByInstanceRow(r(0).asInstanceOf[Option[String]].get, r(1).asInstanceOf[Option[Long]].get, r(2).asInstanceOf[Option[Long]].get, r(3).asInstanceOf[Option[Long]].get, r(4).asInstanceOf[Option[Long]].get, r(5).asInstanceOf[Option[Long]].get, r(6).asInstanceOf[Option[Long]].get, r(7).asInstanceOf[Option[Long]].get, r(8).asInstanceOf[Option[Long]].get, r(9).asInstanceOf[Option[Long]].get, r(10).asInstanceOf[Option[Long]].get, r(11).asInstanceOf[Option[Long]].get, r(12).asInstanceOf[Option[Long]].get, r(13).asInstanceOf[Option[Long]].get, r(14).asInstanceOf[Option[Long]].get, r(15).asInstanceOf[Option[Long]].get, r(16).asInstanceOf[Option[Long]].get, r(17).asInstanceOf[Option[Long]].get, r(18).asInstanceOf[Option[Long]].get, r(19).asInstanceOf[Option[Long]].get, r(20).asInstanceOf[Option[Long]].get, r(21).asInstanceOf[Option[Long]].get, r(22).asInstanceOf[Option[Long]].get, r(23).asInstanceOf[Option[Long]].get), (_:Any) =>  throw new Exception("Inserting into ? projection not supported."))
    ...
    /** Database column SUM_NUMBER_OF_BYTES_READ SqlType(BIGINT UNSIGNED) */
    ...
    /** Database column SUM_NUMBER_OF_BYTES_WRITE SqlType(BIGINT UNSIGNED) */
  ...
  /** Collection-like TableQuery object for table SocketSummaryByInstance */
  lazy val SocketSummaryByInstance = new TableQuery(tag => new SocketSummaryByInstance(tag))
}
