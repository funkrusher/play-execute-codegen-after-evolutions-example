package tables
// AUTO-GENERATED Slick data model for table FileSummaryByEventName
trait FileSummaryByEventNameTable {
  ...
  /** Entity class storing rows of table FileSummaryByEventName
  ...
  /** Collection-like TableQuery object for table FileSummaryByEventName */
  lazy val FileSummaryByEventName = new TableQuery(tag => new FileSummaryByEventName(tag))
}
