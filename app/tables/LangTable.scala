...
trait LangTable {
  ...
  case class LangRow(langId: Int, code: String, description: Option[String])
  ...
  class Lang(_tableTag: Tag) extends profile.api.Table[LangRow](_tableTag, Some("testshop"), "lang") {
