...
trait ProductLangTable {
  ...
  self:TablesRoot with LangTable with ProductTable  =>
  ...
  class ProductLang(_tableTag: Tag) extends profile.api.Table[ProductLangRow](_tableTag, Some("testshop"), "product_lang") {
